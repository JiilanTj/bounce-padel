        ...
        <header className="relative flex h-[85vh] min-h-[600px] w-full items-center justify-center overflow-hidden">
            ...
            <div className="container relative z-10 mx-auto max-w-4xl px-6 text-center">
                ...
                <p className="mx-auto mb-10 max-w-2xl text-lg font-light leading-relaxed text-gray-300 md:text-xl">
                    Experience world-class WPT standard courts, premium
                    amenities, and a vibrant community designed for the modern
                    player.
                </p>
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <button className="h-12 w-full transform rounded-lg bg-primary px-8 text-base font-bold text-[#112217] transition-all hover:scale-105 hover:bg-green-600 sm:w-auto">
                        Book a Court
                    </button>
