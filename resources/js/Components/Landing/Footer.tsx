export default function Footer() {
    return (
        <footer className="border-t border-[#23482f] bg-[#0a160e] pb-8 pt-16">
                ...
                <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-4">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-sm leading-relaxed text-gray-400">
                            The ultimate destination for padel enthusiasts.
                            Premium courts, professional coaching, and a vibrant
                            community.
                        </p>
                    ...
                    <div className="flex flex-col gap-4">
                        <h3 className="text-lg font-bold text-white">Club</h3>
                        <a
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-3 text-sm text-gray-400">
                            ...
                            <span>123 Padel Avenue, Sportsville</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-gray-400">
                            <span className="material-symbols-outlined text-primary">
                                call
                        ...
                        <div className="flex items-center gap-3 text-sm text-gray-400">
                            ...
                            <span>hello@bouncepadel.com</span>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 md:flex-row">
                    <p className="text-sm text-gray-500">
                        © 2024 Bounce Padel Club. All rights reserved.
                    </p>
