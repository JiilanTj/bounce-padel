...
export const printRentalReceipt = (
    ...
    const itemsHtml = order.items
        ...
        <div class="mb-1">
            ...
            ${
                item.notes
                    ? `<div style="font-size: 10px; color: #666; font-style: italic;">${item.notes}</div>`
                    : ''
            }
        </div>
    `,
    ...
    const content = `
        ...
        <body>
            <div class="text-center mb-2">
                ...
                <div style="font-size: 10px;">Rental Receipt</div>
            </div>
            ...
            <div class="mb-2">
                <div class="font-bold mb-1">Equipment</div>
                ${itemsHtml}
            </div>
